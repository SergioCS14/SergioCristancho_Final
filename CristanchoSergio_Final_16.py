...
count = 0
while (comp(T_0) > err):
    x_1 = x_0 + np.random.uniform(-2,2)
    y_1 = y_0 + np.random.uniform(-2,2)
    t_1 = t_0 + np.random.uniform(-1,1)
    v_1 = v_0 + np.random.uniform(-1,1)
...
print("coordenada x: ",x_0," +/- ",2)
print("coordenada y: ",y_0," +/- ",2)
print("tiempo lanzamiento: ",t_0," +/- ",1)
print("velocidad del sonido: ", v_0, " +/- ",1)
